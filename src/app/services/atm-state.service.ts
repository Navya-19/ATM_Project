...
export class AtmStateService {
  ...
  private _behaviorSubject: BehaviorSubject<Currency[] | null> = new BehaviorSubject<Currency[] | null> (null);
  ...
  public getCurrentStock(): Observable<Currency[] | null> { return this._behaviorSubject.asObservable(); }
